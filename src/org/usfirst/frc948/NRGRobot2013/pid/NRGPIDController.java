...
/* the project.                                                               */
/*----------------------------------------------------------------------------*/
package org.usfirst.frc948.NRGRobot2013.pid;
 ...
 * @NRG VERSION 
 */
public class NRGPIDController implements IUtility, LiveWindowSendable, Controller {
    ...
    private class PIDTask extends TimerTask {
        ...
        private NRGPIDController m_controller;

        public PIDTask(NRGPIDController controller) {
            if (controller == null) {
     ...
     */
    public NRGPIDController(double Kp, double Ki, double Kd, double Kf,
     ...
     * @param period 
     */
    public NRGPIDController(double Kp, double Ki, double Kd, PIDSource source, PIDOutput output, double period) {
     ...
     * @param output The PIDOutput object that is set to the output percentage
     */
    public NRGPIDController(double Kp, double Ki, double Kd, PIDSource source, PIDOutput output) {
     ...
     * @param output The PIDOutput object that is set to the output percentage
     */
    public NRGPIDController(double Kp, double Ki, double Kd, double Kf, PIDSource source, PIDOutput output) {
