...
public class DiscMagazine extends Subsystem {
    ...
    Solenoid magPistonOut = new Solenoid(0, 0); //TODO find slot and channel for magazine solenoid.
    Solenoid magPistonIn = new Solenoid(0, 0);
