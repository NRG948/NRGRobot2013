...
public class Drive extends Subsystem 
{
    ...
    public static final int MOTOR_LEFT_CHANNEL = 1;
    public static final int MOTOR_RIGHT_CHANNEL = 2;
    
    //jaguars:
    private Jaguar LEFT_MOTOR;
    private Jaguar RIGHT_MOTOR;
    ...
    public void Drive() 
    {
        LEFT_MOTOR = new Jaguar(MOTOR_LEFT_CHANNEL);
        RIGHT_MOTOR = new Jaguar(MOTOR_RIGHT_CHANNEL);
    }
    
    public void tankDrive(Joystick leftJoystick, Joystick rightJoystick) 
    {
        LEFT_MOTOR.set(leftJoystick.getY()*-1);
        RIGHT_MOTOR.set(rightJoystick.getY()*-1);
    }
