...
public class PIDShooter extends PIDSubsystem implements IShooter {
    ...
    private Encoder shooterQuadrature = RobotMap.shooterQuadrature;
    ...
    SpeedController shootMotor = RobotMap.shooterMotor;
    Encoder shootQuadrature = RobotMap.shooterQuadrature;
    ...
    protected double returnPIDInput() {
        ...
        double rate = shooterQuadrature.getRate();
    ...
    protected void usePIDOutput(double pidOutput) {
        ...
        if ( Math.abs(pid.getError()) > pidDeactivationConstant )
        {
            ...
            pid.setPID(P,I,D);
            double speed = currentMotorSpeed + pidOutput * pidOutputScaleValue;
