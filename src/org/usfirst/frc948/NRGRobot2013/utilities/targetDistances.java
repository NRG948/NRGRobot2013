...
public class targetDistances {
    ...
    public void targetDistances(double highTargetDist, double middleTargetDist, double lowTargetDist, boolean checkHighT, boolean checkMiddleT, boolean checkLowT){
