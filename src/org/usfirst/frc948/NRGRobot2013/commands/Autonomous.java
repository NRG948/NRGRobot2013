...
public class Autonomous extends CommandGroup {
    ...
    public static void initPreferences() {
        double[][] defaults = {
            {  7.92, 34.83,   9.0, 2.0, 2700.0, -90.0, 22.5, 29.50, 0.00, 22.5, 8.50, 21.5, 6.50,  0.01 },  // left
            { 14.50, 35.83,   0.0, 2.0, 2825.0, -50.0, 22.5, 29.50, 0.00, 22.5, 8.50, 21.5, 6.50, -9.00 },  // center
            { 19.08, 34.83, -20.0, 2.0, 2700.0,   0.0, 22.5, 29.50, 0.00, 22.5, 8.50, 21.5, 6.50,  0.01 }   // right
        };
