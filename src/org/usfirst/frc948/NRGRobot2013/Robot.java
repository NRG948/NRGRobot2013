...
public class Robot extends IterativeRobot {
	...
	RobotMap.init();
        ...
        shooterQuadrature = new NRGEncoder(RobotMap.shooterQuadrature, 400);
...
//        initPreferences();
    ...
    private void periodicAll() {
        ...
        Robot.shooterQuadrature.update();
        ...
        LCD.println(true, 4, "RPM:" + shooterQuadrature.getRPM());
        LCD.update();
        
        long curr = System.currentTimeMillis();
        SmartDashboard.putNumber("Robot period", curr - last);
        last = curr;
    }
