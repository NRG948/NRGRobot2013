...
public class OI {
    ...
    Button aimUp = new DigitalIOButton(14);
    Button aimDown = new DigitalIOButton(12);
    ...
    public OI() {
        ...
        aimUp.whenPressed(new SetMotorPower(RobotMap.shooterAngleMotor, -1.0));
        aimUp.whenReleased(new SetMotorPower(RobotMap.shooterAngleMotor, 0.0));
        aimDown.whenPressed(new SetMotorPower(RobotMap.shooterAngleMotor, 1.0));
        aimDown.whenReleased(new SetMotorPower(RobotMap.shooterAngleMotor, 0.0));
