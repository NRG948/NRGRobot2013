...
public class OI {
    ...
    Button btnClimbDisengage = new DigitalIOButton(12);
    Button btnClimbEngage =  new DigitalIOButton(14);
    
    Button shootButton = new DigitalIOButton(16);
    ...
    public OI() {
        ...
        SmartDashboard.putData("Drive 10 feet (1.0)", new DriveStraightDistance(1, 10));
        ...
        SmartDashboard.putDouble("Servo Value", RobotMap.cameraServo.getAngle());
    }
    ...
    public double getCameraTilt(){
        double angle = MathHelper.reverseNormalizeValue(getAnalog(4), MIN_CYPRESS_VOLTAGE, MAX_CYPRESS_VOLTAGE);
        return angle;
    }
