...
public class RobotMap {
    ...
    public static AnalogChannel shooterAnglePotentiometer; 
	...
	LiveWindow.addSensor("Shooter", "shootQuadrature", shooterQuadrature);
        shooterQuadrature.setDistancePerPulse(0.05);//todo: need to calibrate the ratio
        ...
        shooterAngleMotor = new Jaguar(0, 0);
    LiveWindow.addActuator("Shooter", "shootAngleMotor", (Jaguar) shooterAngleMotor);
    
        shooterAnglePotentiometer = new AnalogChannel(0);
    LiveWindow.addSensor("Shooter", "shooterAnglePotentiometer", shooterAnglePotentiometer);
